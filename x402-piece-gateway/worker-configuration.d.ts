/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 423789f4518de25cafd886421a7d8dd8)
// Runtime types generated with workerd@1.20260124.0 2025-09-08 enable_request_signal,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./bin/x402-piece-gateway");
	}
	interface DevEnv {
		DB: D1Database;
		ENVIRONMENT: "dev";
		...
		TOKEN: {"ADDRESS":"0x036CbD53842c5426634e7929541eC2318f3dCF7e","DECIMALS":6,"NAME":"USDC","VERSION":"2"};
		NETWORK: "base-sepolia";
		PIECE_RETRIEVER: Fetcher /* filbeam-piece-retriever */;
	}
	interface CalibrationEnv {
		DB: D1Database;
		ENVIRONMENT: "calibration";
		DNS_ROOT: ".calibration.x402.filbeam.io";
		PIECE_RETRIEVER_DNS_ROOT: ".calibration.filbeam.io";
		FACILITATOR_URL: "https://x402.org/facilitator";
		TOKEN: {"ADDRESS":"0x036CbD53842c5426634e7929541eC2318f3dCF7e","DECIMALS":6,"NAME":"USDC","VERSION":"2"};
		NETWORK: "base-sepolia";
		PIECE_RETRIEVER: Fetcher /* filbeam-piece-retriever-calibration */;
	}
	interface Env {
		DB: D1Database;
		ENVIRONMENT?: "dev" | "calibration";
		DNS_ROOT: ".x402.localhost" | ".calibration.x402.filbeam.io" | ".test";
		PIECE_RETRIEVER_DNS_ROOT: ".localhost" | ".calibration.filbeam.io" | ".test";
		FACILITATOR_URL: "https://x402.org/facilitator";
		TOKEN: {"ADDRESS":"0x036CbD53842c5426634e7929541eC2318f3dCF7e","DECIMALS":6,"NAME":"USDC","VERSION":"2"};
		NETWORK: "base-sepolia";
		PIECE_RETRIEVER: Fetcher /* filbeam-piece-retriever */ | Fetcher /* filbeam-piece-retriever-calibration */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DNS_ROOT" | "PIECE_RETRIEVER_DNS_ROOT" | "FACILITATOR_URL" | "TOKEN" | "NETWORK">> {}
}
