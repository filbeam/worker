/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env dev` (hash: d3a9dba1ad4d82e1dd9c382442564b2c)
// Runtime types generated with workerd@1.20251210.0 2025-09-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./bin/x402-piece-retriever");
	}
	interface Env {
		X402_METADATA_KV: KVNamespace;
		ENVIRONMENT: "dev" | "calibration";
		DNS_ROOT: ".x402.localhost" | ".x402.calibration.filbeam.io";
		PIECE_RETRIEVER_DNS_ROOT: ".localhost" | ".calibration.filbeam.io";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DNS_ROOT" | "PIECE_RETRIEVER_DNS_ROOT" | "FACILITATOR_URL" | "TOKEN_ADDRESS" | "TOKEN_DECIMALS" | "NETWORK">> {}
}
